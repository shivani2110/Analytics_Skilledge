#A matrix with 10 values from 1 to 10 and number of rows as 5 where byrow is TRUE
matrix_a <- matrix(1:10, byrow = TRUE, nrow = 5)
matrix_a
#To print the dimension of the matrix 
dim(matrix_a)
#A matrix with 10 values from 1 to 10 and number of rows as 5 where byrow is FALSE
